...
export const TOOL_IMPORTS: Record<string, () => Promise<any>> = {
  ...
  'nextjs-api-route-generator': () => import('@/features/tools/tools/nextjs-api-route-generator'),
  'og-meta-tag-preview': () => import('@/features/tools/tools/og-meta-tag-preview'),
  'pixel-to-rem-converter': () => import('@/features/tools/tools/pixel-to-rem-converter'),
  ...
  'url-encoder-decoder': () => import('@/features/tools/tools/url-encoder-decoder'),
