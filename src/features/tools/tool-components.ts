...
export const TOOL_IMPORTS: Record<string, () => Promise<any>> = {
  ...
  'color-palette-generator': () => import('@/features/tools/tools/color-palette-generator'),
  'css-to-tailwind': () => import('@/features/tools/tools/css-to-tailwind'),
  'figma-svg-to-react': () => import('@/features/tools/tools/figma-svg-to-react'),
  'framer-motion-code-builder': () => import('@/features/tools/tools/framer-motion-code-builder'),
  'github-profile-card-generator': () => import('@/features/tools/tools/github-profile-card-generator'),
  'json-formatter': () => import('@/features/tools/tools/json-formatter'),
