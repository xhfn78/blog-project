...
import { AI_FORMATS } from "@/shared/config/ai-formats";
...
function SlimmerToolUI() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div>
        <ToolSection title="Slimmed Output">
        ...
        <Card className="mt-4">
          <CardHeader>
            <CardTitle>Slimming Options</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <Label htmlFor="strip-imports">Strip Imports</Label>
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="compress-whitespace">Compress Whitespace</Label>
        ...
        <Card className="mt-4">
          <CardHeader>
            <CardTitle>One-Click AI Direct Injection</CardTitle>
          </CardHeader>
          <CardContent className="flex flex-wrap gap-2">
            {Object.entries(AI_FORMATS).map(([key, format]) => (
              <CopyButton
                key={key}
                text={format.template(processedText)}
                variant="outline"
                size="sm"
              >
                Copy for {format.name}
              </CopyButton>
            ))}
          </CardContent>
        </Card>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          <Card className="mt-4">
            <CardHeader>
              <CardTitle>Real-time Savings Dashboard</CardTitle>
            </CardHeader>
            <CardContent className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col space-y-1">
                <span className="text-sm text-gray-500">Slimmed Tokens</span>
              ...
              <div className="col-span-2 flex flex-col space-y-2 p-4 bg-green-50 rounded-lg">
                ...
                <p className="text-xl font-bold text-green-900">
                  ...
                  &nbsp;tokens!
                  (<Badge variant="outline">{percentageSaved}%</Badge> reduction)
                </p>
                <p className="text-sm text-gray-600">
                  Estimated cost saving: <span className="font-mono">${costSaved}</span>
                </p>
              </div>
            </CardContent>
          </Card>
