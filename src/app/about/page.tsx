    ...
    <div className="flex flex-col">
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <section className="mb-16">
          ...
          <div className="text-lg text-muted-foreground leading-relaxed mb-6 break-keep">
            바이브코딩 도구 모음은 개발자의 시간을 가장 가치있게 만드는 것을 목표로 합니다.
            프론트엔드 개발자들이 일상적으로 마주하는 반복 작업과 번거로운 변환 과정을
            빠르고 간편하게 처리할 수 있도록 돕습니다.
          </div>
          <div className="text-lg text-muted-foreground leading-relaxed break-keep">
        ...
        <section className="mb-16 bg-muted/30 p-8 rounded-lg">
          ...
          <div className="space-y-4 text-lg text-muted-foreground leading-relaxed break-keep">
            <p>
        ...
        <section className="mb-16">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="p-6 border-l-4 border-blue-500 bg-blue-50/50 dark:bg-blue-950/20 rounded-r-lg">
              ...
              <p className="text-muted-foreground mb-3 break-keep">
